...
import com.foodshare.security.JwtAuthenticationFilter;
import com.foodshare.security.JwtTokenProvider;
import com.foodshare.security.CustomUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.GET, "/donations/search").permitAll()
                        .requestMatchers(HttpMethod.GET, "/donations/**").permitAll()
